...
int main()
{
    ...
    freopen("back_in_black_chapter_1_validation_input.txt", "r", stdin);
    freopen("back_in_black_chapter_1_validation_output.txt", "w", stdout);
    ll tt;
    cin>>tt;
    rep(xx,1,tt+1)
    {
