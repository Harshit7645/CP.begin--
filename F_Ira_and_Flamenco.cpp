...
int main()
{
    ...
    while(tt--)
    {
        ...
        int p1=0,p2=0,n1=next.size();
        ll ans=0,mx=m[arr[0]];
        for(p1=0;p1<n1;p1++)
        {
            p2++;
            while(next[p2]-next[p1]<k && p2<n1)
            {
                mx = (mx * m[next[p2]])%M;
                p2++;
            }
        ...
        // cout<<endl;
        //ll ans=0;
        // rep(i,0,next.size()-k+1)
        // {
        //     if(next[i]+k-1==next[i+k-1])
        //     {
        //         ans=(ans+mult[i]);
        //         ans=ans%M;
        //     }
        // }
        //cout<<mult.size()<<" "<<next.size()-k<<endl;
        cout<<ans<<endl;
    }
}   