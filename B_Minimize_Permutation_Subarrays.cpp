...
int main()
{
    ...
    while(tt--)
    {
        ...
        {
            if(ind1<maxi)
            cout<<ind2+1<<" "<<maxi+2<<endl;
            else
            cout<<ind2+1<<" "<<maxi<<endl;
        }
        else
        {
            if(maxi<ind1 && ind2<ind1)
            cout<<ind2+1<<" "<<maxi+1<<endl;
            else if(maxi>ind1 && ind2>ind1)
            cout<<ind2+1<<" "<<maxi+1<<endl;
            else
            cout<<ind1+1<<" "<<maxi+1<<endl;
        }
    }
}   